...
to 8%, anti-chasing band widened to -1.5%/+7.0%. Scoring weights rebalanced:
Relative Strength 25%, Pattern Confirmation 20%, Volume 20%, Trend Proximity
15% (now rewards tight bases over extension), MACD 15%, Analyst Rating 5%.
...
rebalanced to prioritize tight technical setups and real momentum/confluence
over a fundamental tie-breaker (this is a technical momentum bot first):

| Factor | Weight | What it measures |
|---|---|---|
| Relative Strength | **25%** | Outperformance vs. SPY over 6 months — the core swing-trading signal |
| Pattern confirmation | **20%** | Number of independent patterns/structural confluence agreeing |
| Volume | **20%** | Volume ratio vs. 20-day average — real conviction on the move |
| Trend Proximity | **15%** | **Inverted from before**: rewards being CLOSE to the 50 EMA (a tight, healthy base), not stretched far above it. A stock at/near its 50 EMA scores highest; one that's already 15%+ extended above it scores 0 for this factor — a parabolic move is worse risk/reward than a tight one, even though both clear the "price > 50 EMA" hard gate |
| MACD strength | 15% | Size of the bullish crossover gap (unchanged) |
| Analyst rating | **5%** (down from 15%) | Strong Buy=100, Buy=75, Hold=40, Sell=10, Strong Sell=0, no coverage=30 — now a minor tie-breaker, not a primary driver |

**Note**: analyst rating is a *scoring* factor, not a hard gate — it was
...
factor. Its weight has since been reduced further (15% → 5%) since this is
fundamentally a technical/momentum strategy.
