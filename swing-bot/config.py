...
MIN_PRICE = 5.0
MIN_MARKET_CAP = 2_000_000_000       # $2B floor (per your Finviz-style spec)
...
# day has already been "chased" by everyone else. This requires today's
# price change to fall in a narrow band: enough to confirm the breakout/move
# is real (not a false start), but not so much that you're buying an
# already-extended candle.
MIN_DAY_GAIN_PCT = 0.5
MAX_DAY_GAIN_PCT = 2.5
...
MIN_RESULTS_PER_SCAN = 8       # if fewer than this clear MIN_SIGNAL_SCORE, backfill with
