...
def send_alert(setup):
    ...
    setup: dict with keys -
        ...
        rating, ema50, sma150, sma200, pattern, volume_ratio, stop_loss,
        take_profit, risk_per_share, reward_per_share, stop_pct, target_pct,
        atr, atr_pct, stop_capped, rs_outperformance, next_earnings, sizing,
        score, score_breakdown, conviction,
    ...
    fields = [
        {
            ...
            "value": (
                ...
                f"{'  [capped]' if setup.get('stop_capped') else ''}\n"
